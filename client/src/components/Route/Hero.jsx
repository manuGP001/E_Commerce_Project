  ...
  return (
    ...
    >
        <div className={`${styles.section} w-[90%] lg:w-[60%]`}>
            <h1 className={`text-[25px] leading-[1.2] lg:text-[60px] text-[#000] font-[600] capitalize`}
            >We have the best for<br/>Everything
            </h1>
            <p className="pt-5 text-[16px] font-[400] font-[Poppins] text-[#000000ba]">
            We're thrilled to have you with us. Get ready for a memorable time and a great experience. We're just a message away if you need anything.
